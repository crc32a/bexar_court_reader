...
if __name__ == "__main__":
    ...
    sid = int(args[1])
    rows = sidlookup(sid)
    cols = ["sid,full_name,birthdate,offense_date,offense_desc,offense_type,",
            "case_desc,bond_status,bond_amount,case_date,judgement_date,",
            "disposition_desc,judgement_desc,original_sentence,",
            "sentence,attorney,attorney_appointed_retained,",
            "reduced_offense_desc" ]
